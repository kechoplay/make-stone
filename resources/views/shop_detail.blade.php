                ...
                <div class="row">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="{{$one['main_image']}}">
                                    </div>
                                </a>
                            </li>
                            @foreach ($subImages as $key => $subImage)
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-{{$key+2}}" role="tab">
                    ...
                    <div class="col-lg-6 col-md-9">
                        <div class="tab-content">
                            ...
                            @foreach ($subImages as $key => $subImage)
                            <div class="tab-pane" id="tabs-{{$key+2}}" role="tabpanel">
                                <div class="product__details__pic__item">
