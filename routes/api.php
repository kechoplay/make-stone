...
Route::prefix('product')->group(function () {
    ...
    Route::post('/{id}/start-bidding', [ProductController::class, 'startBidding'])->name('product.startBidding');
    Route::post('/{id}/stop-bidding', [ProductController::class, 'stopBidding'])->name('product.stopBidding');
});
//cai dat
